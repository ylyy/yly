...
//---------------------------------------------------------------------------------------------------------------------
AudioPlay::AudioPlay(bool internalDAC /* = false */, uint8_t channelEnabled /* = I2S_DAC_CHANNEL_BOTH_EN */, uint8_t i2sPort)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setBufsize(int rambuf_sz, int psrambuf_sz)
{
    if (InBuff.isInitialized())
    {
        log_e("AudioPlay::setBufsize must not be called after audio is initialized");
        return;
    }
    InBuff.setBufsize(rambuf_sz, psrambuf_sz);
};

void AudioPlay::initInBuff()
{
    if (!InBuff.isInitialized())
    {
...
//---------------------------------------------------------------------------------------------------------------------
esp_err_t AudioPlay::I2Sstart(uint8_t i2s_num)
{
...
esp_err_t AudioPlay::I2Sstop(uint8_t i2s_num)
{
    return i2s_stop((i2s_port_t)i2s_num);
}
//---------------------------------------------------------------------------------------------------------------------
esp_err_t AudioPlay::i2s_mclk_pin_select(const uint8_t pin)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setConnectionTimeout(uint16_t timeout_ms, uint16_t timeout_ms_ssl)
{
    if (timeout_ms)
...
//
bool AudioPlay::connectToStreamingAPI(const char* url) {
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::connecttohost(const char *host, const char *user, const char *pwd)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::httpPrint(const char *host)
{
    // user and pwd for authentification only, can be empty
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setFileLoop(bool input)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::UTF8toASCII(char *str)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::connecttospeech(const char *speech, const char *lang)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::urlencode(char *buff, uint16_t buffLen, bool spacesOnly)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::showID3Tag(const char *tag, const char *value)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::unicode2utf8(char *buff, uint32_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::latinToUTF8(char *buff, size_t bufflen)
{
...
//---------------------------------------------------------------------------------------------------------------------
size_t AudioPlay::readAudioHeader(uint32_t bytes)
{
...
//---------------------------------------------------------------------------------------------------------------------
int AudioPlay::read_WAV_Header(uint8_t *data, size_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
int AudioPlay::read_FLAC_Header(uint8_t *data, size_t len)
{
    static size_t headerSize;
...
//---------------------------------------------------------------------------------------------------------------------
int AudioPlay::read_ID3_Header(uint8_t *data, size_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
int AudioPlay::read_M4A_Header(uint8_t *data, size_t len)
{
    /*
           ftyp
...
//---------------------------------------------------------------------------------------------------------------------
size_t AudioPlay::process_m3u8_ID3_Header(uint8_t *packet)
{
    uint8_t ID3version;
    size_t id3Size;
...
//---------------------------------------------------------------------------------------------------------------------
// bool AudioPlay::readPlayListData()
// {
...
// }
//----------------------------------------------------------------------------------------------------------------------
// const char *AudioPlay::parsePlaylist_M3U()
// {
...
// }
//----------------------------------------------------------------------------------------------------------------------
// const char *AudioPlay::parsePlaylist_PLS()
// {
//     uint8_t lines = m_playlistContent.size();
//     int pos = 0;
//     char *host = nullptr;
...
// }
// //----------------------------------------------------------------------------------------------------------------------
// const char *AudioPlay::parsePlaylist_ASX()
...
// }
// //----------------------------------------------------------------------------------------------------------------------
// const char *AudioPlay::parsePlaylist_M3U8()
// {
//     uint8_t lines = m_playlistContent.size();
//     bool f_begin = false;
//     uint8_t occurence = 0;
...
// }
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::STfromEXTINF(char *str)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::processLocalFile()
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::processWebStreamTS()
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::processWebStreamHLS()
{
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::parseHttpResponseHeader()
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::initializeDecoder()
{
    uint32_t gfH = 0;
    uint32_t hWM = 0;
    switch (m_codec)
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::parseContentType(char *ct)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::showstreamtitle(const char *ml)
{
    // example for ml:
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::showCodecParams()
{
...
//---------------------------------------------------------------------------------------------------------------------
int AudioPlay::findNextSync(uint8_t *data, size_t len)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setDecoderItems()
{
    if (m_codec == CODEC_MP3)
    {
...
//---------------------------------------------------------------------------------------------------------------------
int AudioPlay::sendBytes(uint8_t *data, size_t len)
{
    int bytesLeft;
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::compute_audioCurrentTime(int bd)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::printDecodeError(int r)
{
    const char *e;
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setPinout(uint8_t BCLK, uint8_t LRC, uint8_t DOUT, int8_t DIN, int8_t MCK)
{
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::getFileSize()
{
    if (!audiofile)
        return 0;
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::getAudioDataStartPos()
{
    if (!audiofile)
        return 0;
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::getAudioFileDuration()
{
    if (getDatamode() == AUDIO_LOCALFILE)
    {
        if (!audiofile)
...
//---------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::getAudioCurrentTime()
{ // return current time in seconds
    return (uint32_t)m_audioCurrentTime;
}
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setAudioPlayPosition(uint16_t sec)
{
    if (m_codec == CODEC_OPUS)
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setVolumeSteps(uint8_t steps)
{
    m_vol_steps = steps;
    if (steps < 1)
...
//---------------------------------------------------------------------------------------------------------------------
uint8_t AudioPlay::maxVolume()
{
    return m_vol_steps;
};
//---------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::getTotalPlayingTime()
{
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setTimeOffset(int sec)
{
    if (m_codec == CODEC_OPUS)
        return false; // not impl. yet
    if (m_codec == CODEC_VORBIS)
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setFilePos(uint32_t pos)
{
    if (m_codec == CODEC_OPUS)
        return false; // not impl. yet
    if (m_codec == CODEC_VORBIS)
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::audioFileSeek(const float speed)
{
    // 0.5 is half speed
    // 1.0 is normal speed
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setSampleRate(uint32_t sampRate)
{
    if (!sampRate)
...
uint32_t AudioPlay::getSampleRate()
{
    return m_sampleRate;
}
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setBitsPerSample(int bits)
{
    if ((bits != 16) && (bits != 8))
        return false;
...
uint8_t AudioPlay::getBitsPerSample()
{
    return m_bitsPerSample;
}
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setChannels(int ch)
{
    if ((ch < 1) || (ch > 2))
        return false;
    m_channels = ch;
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::setBitrate(int br)
{
    m_bitRate = br;
    if (br)
        return true;
...
uint32_t AudioPlay::getBitRate(bool avg)
{
    if (avg)
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setI2SCommFMT_LSB(bool commFMT)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::computeVUlevel(int16_t sample[2])
{
...
//---------------------------------------------------------------------------------------------------------------------
bool AudioPlay::playSample(int16_t sample[2])
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setTone(int8_t gainLowPass, int8_t gainBandPass, int8_t gainHighPass)
{
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::forceMono(bool m)
{                      // #100 mono option
    m_f_forceMono = m; // false stereo, true mono
}
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setBalance(int8_t bal)
{ // bal -16...16
    if (bal < -16)
        bal = -16;
    if (bal > 16)
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::setVolume(uint8_t vol, uint8_t curve)
...
//---------------------------------------------------------------------------------------------------------------------
uint8_t AudioPlay::getI2sPort()
{
    return m_i2s_num;
}
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::computeLimit()
...
int32_t AudioPlay::Gain(int16_t s[2])
{
    int32_t v[2];
...
//---------------------------------------------------------------------------------------------------------------------
void AudioPlay::IIR_calculateCoefficients(int8_t G0, int8_t G1, int8_t G2)
...
//---------------------------------------------------------------------------------------------------------------------
int16_t *AudioPlay::IIR_filterChain0(int16_t iir_in[2], bool clear)
{ // Infinite Impulse Response (IIR) filters
...
//---------------------------------------------------------------------------------------------------------------------
int16_t *AudioPlay::IIR_filterChain1(int16_t iir_in[2], bool clear)
{ // Infinite Impulse Response (IIR) filters
...
//---------------------------------------------------------------------------------------------------------------------
int16_t *AudioPlay::IIR_filterChain2(int16_t iir_in[2], bool clear)
{ // Infinite Impulse Response (IIR) filters
...
//----------------------------------------------------------------------------------------------------------------------
bool AudioPlay::ts_parsePacket(uint8_t *packet, uint8_t *packetStart, uint8_t *packetLength)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint16_t AudioPlay::readMetadata(uint16_t maxBytes, bool first)
{
...
//----------------------------------------------------------------------------------------------------------------------
size_t AudioPlay::chunkedDataTransfer(uint8_t *bytes)
{
...
//----------------------------------------------------------------------------------------------------------------------
boolean AudioPlay::streamDetection(uint32_t bytesAvail)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::m4a_correctResumeFilePos(uint32_t resumeFilePos)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::flac_correctResumeFilePos(uint32_t resumeFilePos)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t AudioPlay::mp3_correctResumeFilePos(uint32_t resumeFilePos)
{
...
//----------------------------------------------------------------------------------------------------------------------
uint8_t AudioPlay::determineOggCodec(uint8_t *data, uint16_t len)
{
